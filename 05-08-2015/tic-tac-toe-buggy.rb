...
def choose_computer_move(player1_moves, player2_moves, winning_combos)
  result = nil
  ...
  if available_moves.include?(5)
    ...
    winning_combos.each do |combo|
      ...
      p1_one_move_to_win = (combo.to_set ^ player1_moves)
      p2_one_move_to_win = (combo.to_set ^ player2_moves)

      if p1_one_move_to_win.length == 1
        result = p1_one_move_to_win.to_a.first
        break
      elsif p2_one_move_to_win.length == 1
        result = p2_one_move_to_win.to_a.first
        break
      else
...
def player_move(is_computer, player1_moves, player2_moves, current_player, board, winning_combos)
  ...
  if current_player == "player2"
    if is_computer
      result = choose_computer_move(player1_moves, player2_moves, winning_combos)
      puts dash_line
